        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                ...
                <div>
                    ...
                    <table style="width: 100%; border: none;">
                        <tr>
                            <td style="padding: 0.5rem; text-align: right; font-weight: bold; border: none;">Enrollment Status:</td>
                        ...
                        <tr>
                            <td style="padding: 0.5rem; text-align: right; font-weight: bold; border: none;">Semester:</td>
                            <td style="padding: 0.5rem; border: none;">Current Semester</td>
                        </tr>
                        <tr>
