...
<body>
    ...
    <div class="container">
        <div class="dashboard-title">Welcome, Student!</div>

        <div class="menu-grid">
            <a href="profile.jsp" class="menu-card">
                <h3>👤 View Profile</h3>
                <p>View your personal information</p>
            </a>

            <a href="viewMarks.jsp" class="menu-card">
                <h3>📊 View Marks</h3>
                <p>Check your academic performance</p>
            </a>

            <a href="viewAttendance.jsp" class="menu-card">
